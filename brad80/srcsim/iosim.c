 ...
 *
 * Copyright (C) 2021 Thomas Reidemeister
 *
 * This module of the simulator contains the I/O simulation.
 *
 * History:
 * <FIXME> (Thomas Reidemeister) Adapted IO simulation to Brad 80s design.
...
static BYTE (*port_in[256]) (void) = {
    ...
    io_trap_in,		    /* port 220 (dc) SIO Data */
    io_trap_in,		    /* port 221 (dd) SIO Status */
    io_trap_in,	        /* port 222 (de) Sys Control (handshake lines in) */
    io_trap_in,		    /* port 223 (df) Debug Control */
	io_trap_in,			/* port 224 */
	io_trap_in,			/* port 225 */
    io_trap_in,	        /* port 226 (e2) FDC board status */
    io_trap_in,	        /* port 227 (e3) FDC board control */
    io_trap_in,	        /* port 228 (e4) WD1771 Command/Status */
    io_trap_in,	        /* port 229 (e5) WD1771 Track */
    io_trap_in,		    /* port 230 (e6) WD1771 Sector */
    io_trap_in,	        /* port 231 (e7) WD1771 Data */
	io_trap_in,			/* port 232 */
	io_trap_in,			/* port 233 */
	io_trap_in,			/* port 234 */
	io_trap_in,			/* port 235 */
...
static void (*port_out[256]) (BYTE) = {
    ...
    io_trap_out,		/* port 220 (dc) SIO Data */
    io_trap_out,	    /* port 221 (dd) SIO Control */
    io_trap_out,	    /* port 222 (de) Sys Control (handshake lines out) */
    io_trap_out,		/* port 223 (df) Debug Control */
